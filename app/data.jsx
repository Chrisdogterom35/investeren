...
const WIDGET_REGISTRY = [
  { id: 'portfolio_line',   label: 'Portfolio over tijd',   desc: 'Waarde vs. ingelegd',            chartTypes: ['line'],    defaultSize: 'large'  },
  { id: 'allocation',       label: 'Verdeling',             desc: 'Aandeel per partij',              chartTypes: ['donut','bar'], defaultSize: 'medium' },
  { id: 'party_comparison', label: 'Inleg vs. waarde',      desc: 'Vergelijking per partij',         chartTypes: ['bar'],     defaultSize: 'medium' },
  { id: 'returns',          label: 'Rendementen',           desc: '% rendement per partij',          chartTypes: ['bars'],    defaultSize: 'small'  },
  { id: 'monthly_inleg',    label: 'Maandelijkse inleg',    desc: 'Historisch inlegpatroon',         chartTypes: ['bar'],     defaultSize: 'small'  },
  { id: 'allocation_lines', label: 'Waarde per allocatie',  desc: 'Waardeontwikkeling per partij',   chartTypes: ['line'],    defaultSize: 'full'   },
  { id: 'party_grid',       label: 'Partijkaarten',         desc: 'Overzichtskaarten',               chartTypes: ['cards'],   defaultSize: 'full'   },
  { id: 'monthly_table',    label: 'Maandoverzicht',        desc: 'P&L en cashflow per maand',       chartTypes: ['table'],   defaultSize: 'medium' },
  { id: 'activity_feed',    label: 'Recente activiteit',    desc: 'Laatste transacties',             chartTypes: ['list'],    defaultSize: 'small'  },
  { id: 'fees_summary',     label: 'Transactiekosten',      desc: 'Totale kosten betaald',           chartTypes: ['stats'],   defaultSize: 'small'  },
  { id: 'metal_holdings',   label: 'Edelmetalen detail',    desc: 'Hoeveelheden edelmetalen',        chartTypes: ['stats'],   defaultSize: 'small'  },
  { id: 'goals',            label: 'Doelen voortgang',      desc: 'Vooruitgang per doel',            chartTypes: ['progress'],defaultSize: 'medium' },
];

const DEFAULT_WIDGETS = [
  { id: 'portfolio_line',   enabled: true,  chartType: 'line',     size: 'large'  },
  { id: 'allocation',       enabled: true,  chartType: 'donut',    size: 'medium' },
  { id: 'party_comparison', enabled: true,  chartType: 'bar',      size: 'medium' },
  { id: 'returns',          enabled: true,  chartType: 'bars',     size: 'small'  },
  { id: 'monthly_inleg',    enabled: true,  chartType: 'bar',      size: 'small'  },
  { id: 'allocation_lines', enabled: true,  chartType: 'line',     size: 'full'   },
  { id: 'party_grid',       enabled: true,  chartType: 'cards',    size: 'full'   },
  { id: 'monthly_table',    enabled: true,  chartType: 'table',    size: 'medium' },
  { id: 'activity_feed',    enabled: true,  chartType: 'list',     size: 'small'  },
  { id: 'fees_summary',     enabled: true,  chartType: 'stats',    size: 'small'  },
  { id: 'metal_holdings',   enabled: false, chartType: 'stats',    size: 'small'  },
  { id: 'goals',            enabled: false, chartType: 'progress', size: 'medium' },
];
